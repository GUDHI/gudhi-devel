...
class Persistence_heat_maps
{
 public:
   ...
   * @param min_ The minimal x and y value of points that are to be taken into account. If set to the same value than
   ...
   * @param max_ The maximal x and y value of points that are to be taken into account. If set to the same value than
