...
/**
 * A procedure used to compare doubles. Typically given two doubles A and B, comparing A == B is not good idea.
 * In this case, we use the procedure almostEqual with the epsi defined at the top of the file.
 * Setting up the epsi gives the user a tolerance on what should be consider equal.
 **/
