...
if(DOXYGEN_FOUND AND DOXYGEN_VERSION VERSION_GREATER_EQUAL 1.9.5)
  ...
  if (CMAKE_PROJECT_NAME STREQUAL "GUDHIdev")
    ...
    set(GUDHI_DOXYGEN_ROOT_UTILS_PATH "*/utilities")
    set(GUDHI_DOXYGEN_ROOT_EXAMPLE_PATH "*/example")
    set(GUDHI_DOXYGEN_ROOT_TEST_PATH "*/test")
    endif()
  ...
  if(DOXYGEN_FOUND)
    message("++ Doxygen version ${DOXYGEN_VERSION} is too old to generate the documentation")
  endif()
