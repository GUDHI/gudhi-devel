...
if(WITH_GUDHI_SANITIZER)
  message("++ WITH_GUDHI_SANITIZER = ${WITH_GUDHI_SANITIZER}")
endif()
if(MSVC)
  add_cxx_compiler_flag("/W3")
  if(WITH_GUDHI_SANITIZER)
    message("sanitizers are not available with MSVC")
  endif()
else()
  ...
  if(WITH_GUDHI_SANITIZER)
    ...
    add_cxx_compiler_flag("-fsanitize=${WITH_GUDHI_SANITIZER}")
    # set(GUDHI_PYTHON_EXTRA_COMPILE_ARGS "${GUDHI_PYTHON_EXTRA_COMPILE_ARGS}'-fsanitize=${WITH_GUDHI_SANITIZER}', ")
  endif()
endif()
