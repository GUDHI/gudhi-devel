...
int main() {
  ...
  std::vector<double> data_1d = rng.get_range<double>(sizes_1d[0], 0., 1.);
  ...
  std::vector<double> data_5d_top_cells = rng.get_range<double>(multiplier_top_cells, 0., 1.);
  std::vector<double> data_5d_vertices = rng.get_range<double>(multiplier_vertices, 0., 1.);
