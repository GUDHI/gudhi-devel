...
class Z2_list_chain_column : public Z2_list_column<Cell_type,Column_pairing_option,Row_access_option>
{
private:
...
template<class Dictionnary_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline Z2_list_chain_column<Dictionnary_type,Cell_type,Column_pairing_option,Row_access_option>::Z2_list_chain_column(Dictionnary_type& pivotToColumnIndex)
	: Base(), pivotToColumnIndex_(&pivotToColumnIndex), pivot_(-1)
{}

template<class Dictionnary_type, class Cell_type, class Column_pairing_option, class Row_access_option>
template<class Chain_type>
inline Z2_list_chain_column<Dictionnary_type,Cell_type,Column_pairing_option,Row_access_option>::Z2_list_chain_column(
...
template<class Dictionnary_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline int Z2_list_chain_column<Dictionnary_type,Cell_type,Column_pairing_option,Row_access_option>::get_pivot() const
{
	return pivot_;
}

template<class Dictionnary_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline Z2_list_chain_column<Dictionnary_type,Cell_type,Column_pairing_option,Row_access_option> &
Z2_list_chain_column<Dictionnary_type,Cell_type,Column_pairing_option,Row_access_option>::operator+=(Z2_list_chain_column &column)
{
...
template<class Dictionnary_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline Z2_list_chain_column<Dictionnary_type,Cell_type,Column_pairing_option,Row_access_option> &
Z2_list_chain_column<Dictionnary_type,Cell_type,Column_pairing_option,Row_access_option>::operator=(Z2_list_chain_column other)
{
