...
public:
	...
	Vector_chain_column(const Vector_chain_column& column, Dictionnary_type& pivotToColumnIndex);
	template<class Row_container_type>
	Vector_chain_column(const Vector_chain_column& column, index columnIndex, Row_container_type &rowContainer, Dictionnary_type& pivotToColumnIndex);
	...
	Vector_chain_column& multiply_and_add(const Field_element_type& v, Vector_chain_column& column);
	Vector_chain_column& multiply_and_add(Vector_chain_column& column, const Field_element_type& v);
...
template<class Dictionnary_type, class Field_element_type, class Cell_type, class Row_access_option>
inline Vector_chain_column<Dictionnary_type,Field_element_type,Cell_type,Row_access_option>::Vector_chain_column(
		const Vector_chain_column& column, Dictionnary_type& pivotToColumnIndex)
	: Base(static_cast<const Base&>(column)),
	  pivotToColumnIndex_(&pivotToColumnIndex),
	  pivot_(column.pivot_),
	  pairedColumn_(column.pairedColumn_)
...
template<class Row_container_type>
inline Vector_chain_column<Dictionnary_type,Field_element_type,Cell_type,Row_access_option>::Vector_chain_column(
		const Vector_chain_column& column, index columnIndex, Row_container_type &rowContainer, Dictionnary_type& pivotToColumnIndex)
...
template<class Dictionnary_type, class Field_element_type, class Cell_type, class Row_access_option>
inline Vector_chain_column<Dictionnary_type,Field_element_type,Cell_type,Row_access_option> &
Vector_chain_column<Dictionnary_type,Field_element_type,Cell_type,Row_access_option>::multiply_and_add(const Field_element_type& v, Vector_chain_column& column)
{
...
template<class Dictionnary_type, class Field_element_type, class Cell_type, class Row_access_option>
inline Vector_chain_column<Dictionnary_type,Field_element_type,Cell_type,Row_access_option> &
Vector_chain_column<Dictionnary_type,Field_element_type,Cell_type,Row_access_option>::multiply_and_add(Vector_chain_column& column, const Field_element_type& val)
{
