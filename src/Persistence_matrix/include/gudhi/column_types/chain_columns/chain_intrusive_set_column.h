...
class Intrusive_set_chain_column : public Intrusive_set_column<Field_element_type,Cell_type,Column_pairing_option,Row_access_option>
{
private:
...
template<class Dictionnary_type, class Field_element_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option>::Intrusive_set_chain_column(Dictionnary_type& pivotToColumnIndex)
	: Base(), pivotToColumnIndex_(&pivotToColumnIndex), pivot_(-1)
{}

template<class Dictionnary_type, class Field_element_type, class Cell_type, class Column_pairing_option, class Row_access_option>
template<class Chain_type>
inline Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option>::Intrusive_set_chain_column(
...
template<class Dictionnary_type, class Field_element_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline int Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option>::get_pivot() const
{
	return pivot_;
}

template<class Dictionnary_type, class Field_element_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline Field_element_type Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option>::get_pivot_value()
{
...
template<class Dictionnary_type, class Field_element_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option> &
Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option>::operator+=(Intrusive_set_chain_column &column)
{
...
template<class Dictionnary_type, class Field_element_type, class Cell_type, class Column_pairing_option, class Row_access_option>
inline Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option> &
Intrusive_set_chain_column<Dictionnary_type,Field_element_type,Cell_type,Column_pairing_option,Row_access_option>::operator=(const Intrusive_set_chain_column &other)
{
