...
class Reduced_cell_set_column_with_row : Reduced_cell_column_with_row<Column_types::SET,typename Master_matrix::Field_type,typename Master_matrix::Column_pairing_option>
{
public:
	struct Cell;
...
public:
	...
	Reduced_cell_set_column_with_row& operator+=(Reduced_cell_set_column_with_row const &column);
	...
	Reduced_cell_set_column_with_row& operator*=(unsigned int const &v);
	template<class Friend_master_matrix>
	friend Reduced_cell_set_column_with_row<Friend_master_matrix> operator*(
...
private:
	using RCC = Reduced_cell_column_with_row<Column_types::SET,typename Master_matrix::Field_type,typename Master_matrix::Column_pairing_option>;
...
inline Reduced_cell_set_column_with_row<Master_matrix>::Reduced_cell_set_column_with_row(matrix_type& matrix, dictionnary_type& pivotToColumnIndex)
	: Reduced_cell_column_with_row<Column_types::SET,typename Master_matrix::Field_type,typename Master_matrix::Column_pairing_option>(), matrix_(matrix), pivotToColumnIndex_(pivotToColumnIndex)
{}
...
inline Reduced_cell_set_column_with_row<Master_matrix>::Reduced_cell_set_column_with_row(
	...
	: Reduced_cell_column_with_row<Column_types::SET,typename Master_matrix::Field_type,typename Master_matrix::Column_pairing_option>(chainIndex, chain, dimension), matrix_(matrix), pivotToColumnIndex_(pivotToColumnIndex)
{}

template<class Master_matrix>
inline Reduced_cell_set_column_with_row<Master_matrix>::Reduced_cell_set_column_with_row(
		const Reduced_cell_set_column_with_row& other)
	: Reduced_cell_column_with_row<Column_types::SET,typename Master_matrix::Field_type,typename Master_matrix::Column_pairing_option>(other), matrix_(other.matrix_), pivotToColumnIndex_(other.pivotToColumnIndex_)
{}
...
template<class Master_matrix>
inline Reduced_cell_set_column_with_row<Master_matrix> &Reduced_cell_set_column_with_row<Master_matrix>::operator+=(const Reduced_cell_set_column_with_row &column)
{
...
template<class Master_matrix>
inline Reduced_cell_set_column_with_row<Master_matrix> &Reduced_cell_set_column_with_row<Master_matrix>::operator*=(const unsigned int &v)
{
