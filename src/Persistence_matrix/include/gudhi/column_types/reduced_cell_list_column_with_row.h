...
class Reduced_cell_list_column_with_row : Reduced_cell_column_with_row<Boost_column_type::LIST>
{
public:
...
inline Reduced_cell_list_column_with_row::Reduced_cell_list_column_with_row()
	: Reduced_cell_column_with_row<Boost_column_type::LIST>()
{}

template<class Chain_type>
inline Reduced_cell_list_column_with_row::Reduced_cell_list_column_with_row(
		index chainIndex, Chain_type& chain)
	: Reduced_cell_column_with_row<Boost_column_type::LIST>(chainIndex, chain)
{}

template<class Chain_type>
inline Reduced_cell_list_column_with_row::Reduced_cell_list_column_with_row(
		index chainIndex, Chain_type& chain, index pairedColumnIndex)
	: Reduced_cell_column_with_row<Boost_column_type::LIST>(chainIndex, chain, pairedColumnIndex)
{}

inline Reduced_cell_list_column_with_row::Reduced_cell_list_column_with_row(
		const Reduced_cell_list_column_with_row& other)
	: Reduced_cell_column_with_row<Boost_column_type::LIST>(other)
{}
