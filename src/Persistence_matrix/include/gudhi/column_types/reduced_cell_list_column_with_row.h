...
class Reduced_cell_list_column_with_row
		: public Reduced_cell_column_with_row<List_cell<Field_element_type>,
											  List_column_type<Field_element_type>,
											  List_row_type<Field_element_type>,
...
template<class Master_matrix, class Field_element_type, class Column_pairing_option>
inline Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option>::Reduced_cell_list_column_with_row(matrix_type& matrix, dictionnary_type& pivotToColumnIndex)
	: RCC(), matrix_(&matrix), pivotToColumnIndex_(&pivotToColumnIndex)
{}

template<class Master_matrix, class Field_element_type, class Column_pairing_option>
template<class Chain_type>
inline Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option>::Reduced_cell_list_column_with_row(
...
template<class Master_matrix, class Field_element_type, class Column_pairing_option>
inline void Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option>::_swap_independent_rows(index rowIndex)
{
...
template<class Master_matrix, class Field_element_type, class Column_pairing_option>
inline bool Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option>::is_non_zero(index rowIndex) const
{
...
template<class Master_matrix, class Field_element_type, class Column_pairing_option>
inline Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option> &Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option>::operator+=(Reduced_cell_list_column_with_row &column)
{
...
template<class Master_matrix, class Field_element_type, class Column_pairing_option>
inline Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option> &Reduced_cell_list_column_with_row<Master_matrix,Field_element_type,Column_pairing_option>::operator*=(unsigned int v)
{
