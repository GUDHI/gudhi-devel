...
class List_boundary_column : public List_column<Field_element_type,Cell_type,Row_access_option>
{
private:
...
public:
	...
	template<class Row_container_type>
	List_boundary_column(const List_boundary_column& column, index columnIndex, Row_container_type &rowContainer);
	...
	List_boundary_column& operator+=(List_boundary_column const &column);
	...
	//this = v * this + column
	List_boundary_column& multiply_and_add(const Field_element_type& v, const List_boundary_column& column);
	//this = this + column * v
	List_boundary_column& multiply_and_add(const List_boundary_column& column, const Field_element_type& v);
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option>::List_boundary_column() : Base()
{}

template<class Field_element_type, class Cell_type, class Row_access_option>
template<class Boundary_type>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option>::List_boundary_column(const Boundary_type &boundary)
	: Base(boundary)
{}

template<class Field_element_type, class Cell_type, class Row_access_option>
template<class Boundary_type>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option>::List_boundary_column(const Boundary_type &boundary, dimension_type dimension)
	: Base(boundary, dimension)
{}

template<class Field_element_type, class Cell_type, class Row_access_option>
template<class Row_container_type>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option>::List_boundary_column(
...
template<class Row_container_type>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option>::List_boundary_column(
		const List_boundary_column& column, index columnIndex, Row_container_type &rowContainer)
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline int List_boundary_column<Field_element_type,Cell_type,Row_access_option>::get_pivot() const
{
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline Field_element_type List_boundary_column<Field_element_type,Cell_type,Row_access_option>::get_pivot_value() const
{
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline void List_boundary_column<Field_element_type,Cell_type,Row_access_option>::clear(index rowIndex)
{
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option> &
List_boundary_column<Field_element_type,Cell_type,Row_access_option>::operator+=(List_boundary_column const &column)
{
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option> &
List_boundary_column<Field_element_type,Cell_type,Row_access_option>::multiply_and_add(const Field_element_type& val, const List_boundary_column& column)
{
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option> &
List_boundary_column<Field_element_type,Cell_type,Row_access_option>::multiply_and_add(const List_boundary_column& column, const Field_element_type& val)
{
...
template<class Field_element_type, class Cell_type, class Row_access_option>
inline List_boundary_column<Field_element_type,Cell_type,Row_access_option> &
List_boundary_column<Field_element_type,Cell_type,Row_access_option>::operator=(
