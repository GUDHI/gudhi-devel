...
class Z2_set_boundary_column : public Z2_set_column<Cell_type,Row_access_option>
{
private:
...
template<class Cell_type, class Row_access_option>
inline Z2_set_boundary_column<Cell_type,Row_access_option>::Z2_set_boundary_column() : Base()
{}

template<class Cell_type, class Row_access_option>
template<class Boundary_type>
inline Z2_set_boundary_column<Cell_type,Row_access_option>::Z2_set_boundary_column(const Boundary_type &boundary)
	: Base(boundary)
{}

template<class Cell_type, class Row_access_option>
template<class Boundary_type>
inline Z2_set_boundary_column<Cell_type,Row_access_option>::Z2_set_boundary_column(const Boundary_type &boundary, dimension_type dimension)
...
template<class Cell_type, class Row_access_option>
inline int Z2_set_boundary_column<Cell_type,Row_access_option>::get_pivot() const
{
...
template<class Cell_type, class Row_access_option>
inline Z2_set_boundary_column<Cell_type,Row_access_option> &
Z2_set_boundary_column<Cell_type,Row_access_option>::operator=(Z2_set_boundary_column other)
{
...
template<class Cell_type, class Row_access_option>
inline void Z2_set_boundary_column<Cell_type,Row_access_option>::_insert_cell(
