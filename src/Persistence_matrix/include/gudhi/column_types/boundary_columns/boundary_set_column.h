...
public:
	...
	template<class Row_container_type>
	Set_boundary_column(const Set_boundary_column& column, index columnIndex, Row_container_type &rowContainer);
...
template<class Row_container_type>
inline Set_boundary_column<Field_element_type,Cell_type,Row_access_option>::Set_boundary_column(
		const Set_boundary_column& column, index columnIndex, Row_container_type &rowContainer)
