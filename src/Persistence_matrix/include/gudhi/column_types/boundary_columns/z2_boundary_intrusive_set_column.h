...
class Z2_intrusive_set_boundary_column : public Z2_intrusive_set_column<Cell_type,Column_pairing_option,Row_access_option>
{
private:
...
template<class Cell_type, class Column_pairing_option, class Row_access_option>
inline Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::Z2_intrusive_set_boundary_column() : Base()
{}

template<class Cell_type, class Column_pairing_option, class Row_access_option>
template<class Boundary_type>
inline Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::Z2_intrusive_set_boundary_column(const Boundary_type &boundary)
	: Base(boundary)
{}

template<class Cell_type, class Column_pairing_option, class Row_access_option>
template<class Boundary_type>
inline Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::Z2_intrusive_set_boundary_column(const Boundary_type &boundary, dimension_type dimension)
	: Base(boundary, dimension)
{}

template<class Cell_type, class Column_pairing_option, class Row_access_option>
template<class Row_container_type>
inline Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::Z2_intrusive_set_boundary_column(
...
template<class Cell_type, class Column_pairing_option, class Row_access_option>
inline int Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::get_pivot() const
{
...
template<class Cell_type, class Column_pairing_option, class Row_access_option>
inline void Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::clear()
{
...
template<class Cell_type, class Column_pairing_option, class Row_access_option>
inline void Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::clear(index rowIndex)
{
	iterator it;
...
template<class Cell_type, class Column_pairing_option, class Row_access_option>
template<class Map_type>
inline void Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::reorder(Map_type &valueMap)
{
	Column_type newSet;
...
template<class Cell_type, class Column_pairing_option, class Row_access_option>
inline Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option> &
Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::operator=(const Z2_intrusive_set_boundary_column &other)
{
...
template<class Cell_type, class Column_pairing_option, class Row_access_option>
inline void Z2_intrusive_set_boundary_column<Cell_type,Column_pairing_option,Row_access_option>::_insert_cell(
