...
class Z2_list_boundary_column : public Z2_list_column<Cell_type,Row_access_option>
{
private:
...
public:
	...
	template<class Row_container_type>
	Z2_list_boundary_column(const Z2_list_boundary_column& column, index columnIndex, Row_container_type &rowContainer);
	...
	Z2_list_boundary_column& operator+=(Z2_list_boundary_column const &column);
...
template<class Cell_type, class Row_access_option>
inline Z2_list_boundary_column<Cell_type,Row_access_option>::Z2_list_boundary_column() : Base()
{}

template<class Cell_type, class Row_access_option>
template<class Boundary_type>
inline Z2_list_boundary_column<Cell_type,Row_access_option>::Z2_list_boundary_column(const Boundary_type &boundary)
	: Base(boundary)
{}

template<class Cell_type, class Row_access_option>
template<class Boundary_type>
inline Z2_list_boundary_column<Cell_type,Row_access_option>::Z2_list_boundary_column(const Boundary_type &boundary, dimension_type dimension)
	: Base(boundary, dimension)
{}

template<class Cell_type, class Row_access_option>
template<class Row_container_type>
inline Z2_list_boundary_column<Cell_type,Row_access_option>::Z2_list_boundary_column(
...
template<class Row_container_type>
inline Z2_list_boundary_column<Cell_type,Row_access_option>::Z2_list_boundary_column(
		const Z2_list_boundary_column& column, index columnIndex, Row_container_type &rowContainer)
...
template<class Cell_type, class Row_access_option>
inline int Z2_list_boundary_column<Cell_type,Row_access_option>::get_pivot() const
{
...
template<class Cell_type, class Row_access_option>
inline void Z2_list_boundary_column<Cell_type,Row_access_option>::clear(index rowIndex)
{
...
template<class Cell_type, class Row_access_option>
inline Z2_list_boundary_column<Cell_type,Row_access_option> &
Z2_list_boundary_column<Cell_type,Row_access_option>::operator+=(Z2_list_boundary_column const &column)
{
...
template<class Cell_type, class Row_access_option>
inline Z2_list_boundary_column<Cell_type,Row_access_option> &Z2_list_boundary_column<Cell_type,Row_access_option>::operator=(Z2_list_boundary_column other)
{
