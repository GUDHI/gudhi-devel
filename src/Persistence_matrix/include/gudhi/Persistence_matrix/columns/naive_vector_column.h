...
inline Naive_vector_column<Master_matrix, Cell_constructor>::Naive_vector_column(Field_operators* operators,
                                                                                 Cell_constructor* cellConstructor)
    : ra_opt(), dim_opt(), chain_opt(), operators_(operators), cellPool_(cellConstructor) 
{
...
template <class Master_matrix, class Cell_constructor>
inline Naive_vector_column<Master_matrix, Cell_constructor>::Naive_vector_column(const Naive_vector_column& column,
                                                                                 Field_operators* operators,
                                                                                 Cell_constructor* cellConstructor)
    : ra_opt(),
...
template <class Master_matrix, class Cell_constructor>
inline typename Naive_vector_column<Master_matrix, Cell_constructor>::id_index
Naive_vector_column<Master_matrix, Cell_constructor>::get_pivot() const 
{
...
template <class Master_matrix, class Cell_constructor>
inline typename Naive_vector_column<Master_matrix, Cell_constructor>::Field_element_type
Naive_vector_column<Master_matrix, Cell_constructor>::get_pivot_value() const 
{
  static_assert(Master_matrix::isNonBasic,
                "Method not available for base columns.");  // could technically be, but is the notion usefull then?
...
template <class Cell_range>
inline Naive_vector_column<Master_matrix, Cell_constructor>&
Naive_vector_column<Master_matrix, Cell_constructor>::multiply_and_add(const Field_element_type& val,
...
template <class Cell_range>
inline Naive_vector_column<Master_matrix, Cell_constructor>&
Naive_vector_column<Master_matrix, Cell_constructor>::multiply_and_add(const Cell_range& column,
...
template <class Master_matrix, class Cell_constructor>
inline Naive_vector_column<Master_matrix, Cell_constructor>&
Naive_vector_column<Master_matrix, Cell_constructor>::multiply_and_add(Naive_vector_column& column,
                                                                       const Field_element_type& val) 
{
  if constexpr (Master_matrix::isNonBasic && !Master_matrix::Option_list::is_of_boundary_type) {
    // assumes that the addition never zeros out this column.
...
template <class Master_matrix, class Cell_constructor>
inline void Naive_vector_column<Master_matrix, Cell_constructor>::_insert_cell(const Field_element_type& value,
                                                                               id_index rowIndex, 
                                                                               Column_type& column) 
{
  if constexpr (Master_matrix::Option_list::has_row_access) {
...
template <class Master_matrix, class Cell_constructor>
inline void Naive_vector_column<Master_matrix, Cell_constructor>::_insert_cell(id_index rowIndex, Column_type& column) 
{
  if constexpr (Master_matrix::Option_list::has_row_access) {
    Cell* new_cell = cellPool_->construct(ra_opt::columnIndex_, rowIndex);
    column.push_back(new_cell);
...
template <class Master_matrix, class Cell_constructor>
inline void Naive_vector_column<Master_matrix, Cell_constructor>::_update_cell(const Field_element_type& value,
                                                                               id_index rowIndex, 
                                                                               index position) 
{
  if constexpr (Master_matrix::Option_list::has_row_access) {
...
template <class Master_matrix, class Cell_constructor>
inline void Naive_vector_column<Master_matrix, Cell_constructor>::_update_cell(id_index rowIndex, index position) 
{
  if constexpr (Master_matrix::Option_list::has_row_access) {
    Cell* new_cell = cellPool_->construct(ra_opt::columnIndex_, rowIndex);
    column_[position] = new_cell;
...
template <class Master_matrix, class Cell_constructor>
template <class Cell_range>
inline bool Naive_vector_column<Master_matrix, Cell_constructor>::_multiply_and_add(const Field_element_type& val,
                                                                                    const Cell_range& column) 
{
  bool pivotIsZeroed = false;
...
template <class Master_matrix, class Cell_constructor>
template <class Cell_range>
inline bool Naive_vector_column<Master_matrix, Cell_constructor>::_multiply_and_add(const Cell_range& column,
                                                                                    const Field_element_type& val) 
{
  ...
  while (itTarget != column_.end() && itSource != column.end()) {
    ...
    if (cellTarget->get_row_index() < cellSource.get_row_index()) {
      ...
      cellTarget->get_element() =
          operators_->multiply_and_add(cellSource.get_element(), val, cellTarget->get_element());
      if (cellTarget->get_element() == Field_operators::get_additive_identity()) {
        if constexpr (Master_matrix::isNonBasic && !Master_matrix::Option_list::is_of_boundary_type) {
          if (cellTarget->get_row_index() == chain_opt::get_pivot()) pivotIsZeroed = true;
        }
...
{
  size_t operator()(
      const Gudhi::persistence_matrix::Naive_vector_column<Master_matrix, Cell_constructor>& column) const {
    std::size_t seed = 0;
