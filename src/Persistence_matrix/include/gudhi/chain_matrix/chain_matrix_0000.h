...
template<class Master_matrix>
inline Chain_matrix<Master_matrix>::Chain_matrix(
		const Chain_matrix &matrixToCopy)
...
template<class Master_matrix>
inline index Chain_matrix<Master_matrix>::get_column_with_pivot(index simplexIndex) const
{
	return pivotToColumnIndex_[simplexIndex];
}

template<class Master_matrix>
inline index Chain_matrix<Master_matrix>::get_pivot(index columnIndex) const
{
