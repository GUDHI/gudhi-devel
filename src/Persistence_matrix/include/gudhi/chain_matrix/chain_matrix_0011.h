...
class Chain_matrix_with_row_access_with_removals : Master_matrix::Chain_pairing_option, Master_matrix::Chain_vine_swap_option, Master_matrix::Chain_representative_cycles_option{
public:
	...
	Chain_matrix_with_row_access_with_removals(Chain_matrix_with_row_access_with_removals& matrixToCopy);
...
template<class Master_matrix>
inline Chain_matrix_with_row_access_with_removals<Master_matrix>::Chain_matrix_with_row_access_with_removals(unsigned int numberOfColumns)
	: Master_matrix::Chain_pairing_option(),
	  Master_matrix::Chain_vine_swap_option(matrix_),
	  Master_matrix::Chain_representative_cycles_option(matrix_, pivotToColumnIndex_),
...
template<class Master_matrix>
inline Chain_matrix_with_row_access_with_removals<Master_matrix>::Chain_matrix_with_row_access_with_removals(Chain_matrix_with_row_access_with_removals &matrixToCopy)
...
template<class Master_matrix>
inline Chain_matrix_with_row_access_with_removals<Master_matrix>::Chain_matrix_with_row_access_with_removals(Chain_matrix_with_row_access_with_removals &&other) noexcept
...
inline void Chain_matrix_with_row_access_with_removals<Master_matrix>::insert_boundary(Boundary_type &boundary, std::vector<index>& currentEssentialCycleIndices)
{
	...
	if constexpr (_barcode_option_is_active()){
		_indexToBar().at(matrix_.at(chain_fp).get_pivot())->death = nextInsertIndex_;
...
template<class Master_matrix>
inline typename Chain_matrix_with_row_access_with_removals<Master_matrix>::Column_type &Chain_matrix_with_row_access_with_removals<Master_matrix>::get_column(index columnIndex)
{
...
template<class Master_matrix>
inline dimension_type Chain_matrix_with_row_access_with_removals<Master_matrix>::get_column_dimension(index columnIndex) const
{
	return matrix_.at(columnIndex).get_dimension();
}

template<class Master_matrix>
inline void Chain_matrix_with_row_access_with_removals<Master_matrix>::add_to(index sourceColumnIndex, index targetColumnIndex)
{
	matrix_.at(targetColumnIndex) += matrix_.at(sourceColumnIndex);
}

template<class Master_matrix>
inline void Chain_matrix_with_row_access_with_removals<Master_matrix>::zero_cell(index columnIndex, index rowIndex)
{
...
template<class Master_matrix>
inline Chain_matrix_with_row_access_with_removals<Master_matrix> &Chain_matrix_with_row_access_with_removals<Master_matrix>::operator=(Chain_matrix_with_row_access_with_removals other)
{
...
template<class Master_matrix>
inline void Chain_matrix_with_row_access_with_removals<Master_matrix>::_insert_chain(std::set<index> &column, dimension_type dimension)
{
	matrix_.emplace(nextInsertIndex_, nextInsertIndex_, column, dimension, matrix_, pivotToColumnIndex_);
...
template<class Master_matrix>
inline void Chain_matrix_with_row_access_with_removals<Master_matrix>::_insert_chain(std::set<index> &column, dimension_type dimension, index pair)
{
	matrix_.emplace(nextInsertIndex_, nextInsertIndex_, column, dimension, matrix_, pivotToColumnIndex_);
...
template<class Master_matrix>
inline void Chain_matrix_with_row_access_with_removals<Master_matrix>::_add_to(const typename Column_type::Column_type &column, std::set<index> &set)
{
	std::pair<std::set<index>::iterator,bool> res_insert;
...
template<class Master_matrix>
inline constexpr typename Chain_matrix_with_row_access_with_removals<Master_matrix>::barcode_type &Chain_matrix_with_row_access_with_removals<Master_matrix>::_barcode()
{
	return swap_opt::isActive_ ? swap_opt::indexToBar_ : pair_opt::indexToBar_;
}

template<class Master_matrix>
inline constexpr typename Chain_matrix_with_row_access_with_removals<Master_matrix>::bar_dictionnary_type &Chain_matrix_with_row_access_with_removals<Master_matrix>::_indexToBar()
{
