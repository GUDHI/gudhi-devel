...
private:
	...
	Base_matrix_with_row_acces_with_removals<Master_matrix> reducedMatrixR_;
	Base_matrix_with_row_acces_with_removals<Master_matrix> mirrorMatrixU_;	//make U not accessible by default and add option to enable access? Inaccessible, it needs less options and we could avoid some ifs.
