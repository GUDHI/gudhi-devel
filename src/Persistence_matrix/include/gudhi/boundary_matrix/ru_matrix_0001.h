...
#include "../utilities.h"
#include "base_matrix_0001.h"

namespace Gudhi {
namespace persistence_matrix {

template<class Master_matrix>
class RU_matrix_with_removals : Master_matrix::RU_pairing_option, Master_matrix::RU_vine_swap_option, Master_matrix::RU_representative_cycles_option{
public:
	...
	RU_matrix_with_removals(std::vector<Boundary_type>& orderedBoundaries);
	RU_matrix_with_removals(unsigned int numberOfColumns);
	RU_matrix_with_removals(RU_matrix_with_removals& matrixToCopy);
	...
	friend void swap(RU_matrix_with_removals<Friend_master_matrix>& matrix1,
					 RU_matrix_with_removals<Friend_master_matrix>& matrix2);
...
inline RU_matrix_with_removals<Master_matrix>::RU_matrix_with_removals(std::vector<Boundary_type> &orderedBoundaries)
	: Master_matrix::RU_pairing_option(),
	  Master_matrix::RU_vine_swap_option(reducedMatrixR_, mirrorMatrixU_),
	  Master_matrix::RU_representative_cycles_option(reducedMatrixR_, mirrorMatrixU_),
...
template<class Master_matrix>
inline RU_matrix_with_removals<Master_matrix>::RU_matrix_with_removals(RU_matrix_with_removals &matrixToCopy)
...
template<class Master_matrix>
template<class Boundary_type>
inline void RU_matrix_with_removals<Master_matrix>::insert_boundary(Boundary_type &boundary)
{
...
template<class Master_matrix>
inline typename RU_matrix_with_removals<Master_matrix>::Row_type RU_matrix_with_removals<Master_matrix>::get_row(index rowIndex)
{
...
template<class Friend_master_matrix>
void swap(RU_matrix_with_removals<Friend_master_matrix>& matrix1,
		  RU_matrix_with_removals<Friend_master_matrix>& matrix2)
{
