...
using full_matrices = matrices_list<z2_ru_rep_option_list>;
using row_access_matrices = matrices_list<z2_ra_ru_rep_option_list>;
using removable_rows_matrices = matrices_list<z2_ra_r_ru_rep_option_list>;
using removable_columns_matrices = matrices_list<z2_r_ru_rep_option_list>;
using max_dim_matrices = matrices_list<z2_dim_ru_rep_option_list>;
using barcode_matrices = matrices_list<z2_barcode_ru_rep_option_list>;
...
BOOST_AUTO_TEST_CASE_TEMPLATE(RU_matrix_z2_rep_max_dimension, Matrix, max_dim_matrices) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(RU_matrix_z2_rep_barcode, Matrix, barcode_matrices) {
	test_barcode<Matrix>();
}
