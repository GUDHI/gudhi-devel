...
BOOST_AUTO_TEST_CASE_TEMPLATE(Boundary_column_constructors, Column, no_row_access_columns) {
...
BOOST_AUTO_TEST_CASE_TEMPLATE(Boundary_column_row_access_constructors, Column, only_row_access_columns) {
	typename Column::Master::row_container_type rows;	//do not destroy before matrix
	std::vector<Column> matrix = build_column_matrix<Column>(rows);
...
BOOST_AUTO_TEST_CASE_TEMPLATE(Boundary_z5_column_other, Column, z5_no_row_access_columns) {
	...
	std::vector<Column> matrix = build_base_boundary_column_matrix<Column>();
...
BOOST_AUTO_TEST_CASE_TEMPLATE(Boundary_z5_column_with_row_access_other, Column, z5_only_row_access_columns) {
	...
	typename Column::Master::row_container_type rows;	//do not destroy before matrix
	std::vector<Column> matrix = build_base_boundary_column_matrix<Column>(rows);
	column_test_boundary_methods<Column>(matrix);
