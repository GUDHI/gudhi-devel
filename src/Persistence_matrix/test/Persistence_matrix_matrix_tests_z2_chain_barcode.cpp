...
using full_matrices = matrices_list<boost::mp11::mp_apply<opt_chain_bar_z2, opts> >;
using row_access_matrices = matrices_list<boost::mp11::mp_apply<opt_chain_bar_z2_ra, opts> >;
using removable_rows_matrices = matrices_list<boost::mp11::mp_apply<opt_chain_bar_z2_ra_r, opts> >;
using removable_columns_matrices = matrices_list<boost::mp11::mp_apply<opt_chain_bar_z2_r, opts> >;
