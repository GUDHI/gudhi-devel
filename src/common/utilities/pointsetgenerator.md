...
* Generates an onSphere.off file with 1000 points randomized on a sphere of dimension 3 and radius 15.2. The seed of the random generator has been set to 42 for reproducibility.
