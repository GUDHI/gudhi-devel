...
#include "../../Coxeter_triangulation/example/cxx-prettyprint/prettyprint.hpp"
...
using Graph_t = boost::adjacency_list < boost::vecS, boost::vecS, boost::undirectedS,
                                        boost::property < Gudhi::vertex_filtration_t,
                                                          Filtration_value >,
                                        boost::property < Gudhi::edge_filtration_t,
                                                          Filtration_value >
                                        >;
using Edge_t = std::pair< Vertex_handle, Vertex_handle >;

using Kernel = CGAL::Epick_d< CGAL::Dimension_tag<3> >;// CGAL::Dynamic_dimension_tag >;
