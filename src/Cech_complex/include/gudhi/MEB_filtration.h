 ...
 * to the squared (or not squared in function of `square_root_filtrations`) radius of its minimal enclosing ball (MEB).
 *
 * Applied on a Čech complex, it recomputes the same values (squared or not in function of `square_root_filtrations`).
 ...
 * the squared radius of the MEB, or to the radius when square_root_filtrations is true.
 ...
 */
template<bool square_root_filtrations = false, typename Kernel, typename SimplicialComplexForMEB, typename PointRange>
