...
class Dynamic_multi_parameter_filtration
{
 ...
 public:
   ...
   */
  reference operator()(size_type g, size_type n)
  {
    GUDHI_CHECK(g < generators_.size() && n < number_of_parameters_, "Out of bound index.");
   ...
   */
  const_reference operator()(size_type g, size_type n) const
  {
    GUDHI_CHECK(g < generators_.size() && n < number_of_parameters_, "Out of bound index.");
    if (generators_[g].size() < number_of_parameters_) return generators_[g][0];
    return generators_[g][n];
