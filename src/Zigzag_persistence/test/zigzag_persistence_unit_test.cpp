...
BOOST_AUTO_TEST_CASE(zigzag_persistence_single) {
  ...
  zp.remove_simplex(simplices[28], filValues[28]);
...
BOOST_AUTO_TEST_CASE(zigzag_persistence_batch_with_iterators) {
  ...
  zp.insert_simplices_contiguously(simplices.begin(), simplices.begin() + 14, filValues.begin());
  ...
  zp.remove_simplices_contiguously(simplices.begin() + 14, simplices.begin() + 16, filValues.begin() + 14);
  zp.insert_simplices_contiguously(simplices.begin() + 16, simplices.begin() + 24, filValues.begin() + 16);
  ...
  zp.remove_simplices_contiguously(simplices.begin() + 24, simplices.begin() + 27, filValues.begin() + 24);

  realIndices.emplace_back(1, 24, 25);
  realBarcode.emplace_back(1, 8, 9);

  zp.insert_simplices_contiguously(simplices.begin() + 27, simplices.begin() + 28, filValues.begin() + 27);

  realIndices.emplace_back(2, 23, 27);
  realBarcode.emplace_back(2, 7, 9);

  zp.remove_simplices_contiguously(simplices.begin() + 28, simplices.begin() + 29, filValues.begin() + 28);
...
BOOST_AUTO_TEST_CASE(zigzag_persistence_batch) {
  ...
  subSimplices = std::vector<std::vector<Vertex_handle> >(simplices.begin() + 28, simplices.begin() + 29);
  subFilValues = std::vector<Filtration_value>(filValues.begin() + 28, filValues.begin() + 29);
  zp.remove_simplices_contiguously(subSimplices, subFilValues);
