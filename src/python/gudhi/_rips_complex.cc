...
void Rips_complex_interface::init_points_sparse(const std::vector<std::vector<double>>& points,
                                                double threshold,
                                                double epsilon)
{
...
void Rips_complex_interface::init_matrix_sparse(const std::vector<std::vector<double>>& matrix,
                                                double threshold,
                                                double epsilon)
{
