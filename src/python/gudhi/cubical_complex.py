...
from .cubical._cubical_complex import (Cubical_complex_interface_, Persistent_cohomology_cubical_interface_,
    Periodic_cubical_complex_interface_, Persistent_cohomology_periodic_cubical_interface_)
...
class CubicalBase_:
    """The CubicalBase_ is a base class for cubical to avoid duplicated code.
    ...
    def __init__(self):
        raise TypeError("CubicalBase_ is not supposed to be constructed.")
...
class CubicalComplex(CubicalBase_):
    ...
    def __init__(self, dimensions=None, top_dimensional_cells=None,
        ...
        if ((dimensions is not None) and (top_dimensional_cells is not None)
            and (perseus_file == '')):
            CubicalBase_.thisptr = Cubical_complex_interface_(dimensions, top_dimensional_cells)
            ...
            if os.path.isfile(perseus_file):
                CubicalBase_.thisptr = Cubical_complex_interface_(perseus_file.encode('utf-8'))
            else:
    ...
    def compute_persistence(self, homology_coeff_field=11, min_persistence=0):
        ...
        :returns: Nothing.
        """
        CubicalBase_.pcohptr = Persistent_cohomology_cubical_interface_(self.thisptr, True)
        CubicalBase_.pcohptr.compute_persistence(homology_coeff_field, min_persistence)


class PeriodicCubicalComplex(CubicalBase_):
    ...
    def __init__(self, dimensions=None, top_dimensional_cells=None,
        ...
        if ((dimensions is not None) and (top_dimensional_cells is not None)
            ...
            CubicalBase_.thisptr = Periodic_cubical_complex_interface_(dimensions, top_dimensional_cells, periodic_dimensions)
        elif ((dimensions is None) and (top_dimensional_cells is not None)
            and (periodic_dimensions is not None) and (perseus_file == '')):
            top_dimensional_cells = np.array(top_dimensional_cells,
                                             copy = False,
            ...
            if os.path.isfile(perseus_file):
                CubicalBase_.thisptr = Periodic_cubical_complex_interface_(perseus_file.encode('utf-8'))
            else:
    ...
    def compute_persistence(self, homology_coeff_field=11, min_persistence=0):
        ...
        :returns: Nothing.
        """
        CubicalBase_.pcohptr = Persistent_cohomology_periodic_cubical_interface_(self.thisptr, True)
        CubicalBase_.pcohptr.compute_persistence(homology_coeff_field, min_persistence)
