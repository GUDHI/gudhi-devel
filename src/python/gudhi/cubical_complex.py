...
class CubicalComplexBaseClass:
    ...
    def betti_numbers(self):
        ...
        :note: betti_numbers function requires :func:`~gudhi.CubicalComplex.compute_persistence`
            or :func:`persistence` function to be launched first.
...
class CubicalComplex(CubicalComplexBaseClass):
    ...
    def compute_persistence(self, homology_coeff_field=11, min_persistence=0):
        ...
        accessed through :func:`~gudhi.CubicalComplexBaseClass.persistent_betti_numbers`,
        :func:`~gudhi.CubicalComplexBaseClass.persistence_intervals_in_dimension`, etc. This function is
        equivalent to :func:`~gudhi.CubicalComplexBaseClass.persistence` when you do not want the list
        :func:`~gudhi.CubicalComplexBaseClass.persistence` returns.
