...
Euclidean_strong_witness_complex_interface::~Euclidean_strong_witness_complex_interface() { delete witness_complex_; }

void Euclidean_strong_witness_complex_interface::create_simplex_tree(Simplex_tree_interface* simplex_tree,
